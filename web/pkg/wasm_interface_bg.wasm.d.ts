...
export const __wbg_decryptionresult_free: (a: number, b: number) => void;
export const __wbg_eiccrypt_free: (a: number, b: number) => void;
export const __wbg_encryptionresult_free: (a: number, b: number) => void;
export const __wbg_get_encryptionresult_time_ms: (a: number) => number;
export const __wbg_pubkeyadder_free: (a: number, b: number) => void;
export const __wbg_set_encryptionresult_time_ms: (a: number, b: number) => void;
...
export const decryptionresult_plaintext: (a: number) => [number, number];
export const eiccrypt_decrypt: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const eiccrypt_decrypt_pdf: (a: number, b: number, c: number, d: number, e: number) => number;
export const eiccrypt_encrypt: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const eiccrypt_encrypt_pdf: (a: number, b: number, c: number, d: number, e: number) => number;
export const eiccrypt_new: () => number;
export const encryptionresult_ciphertext: (a: number) => [number, number];
...
export const decryptionresult_time_ms: (a: number) => number;
